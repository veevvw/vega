...
class YukkiBot(Client):
    def __init__(self):
        LOGGER(__name__).info(f"★انا الان اعمل علي فيجاا★")
        super().__init__(
            "YukkiMusicBot",
    ...
    async def start(self):
        ...
        try:
            await self.send_message(
                config.LOG_GROUP_ID, "★انا الان اعمل علي فيجاا★"
            )
        except:
        ...
        LOGGER(__name__).info(f"Music★انا الان اعمل علي فيجاا★ as {self.name}")
